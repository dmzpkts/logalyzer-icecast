...
var QueryEditor = (function(SelectorEditor) { "use strict";
  ...
  removeSelector (index) {
	...
	function encapsulateStyles(node) {
		setAttribute(node, "svelte-2333783806", "");
	}

	function add_css() {
		var style = createElement("style");
		style.id = 'svelte-2333783806-style';
		style.textContent = "[svelte-2333783806].query-editor,[svelte-2333783806] .query-editor{font-family:monospace}[svelte-2333783806].options-editor,[svelte-2333783806] .options-editor,[svelte-2333783806].selector-editor,[svelte-2333783806] .selector-editor,[svelte-2333783806].selector-editor .selector,[svelte-2333783806] .selector-editor .selector{padding-left:2em;display:flex;flex-direction:column}[svelte-2333783806].options-editor .option,[svelte-2333783806] .options-editor .option,[svelte-2333783806].selector-editor .selector .clause,[svelte-2333783806] .selector-editor .selector .clause{padding:.5em 2em;display:flex;flex-direction:row}[svelte-2333783806].query-result,[svelte-2333783806] .query-result{border:1px solid}[svelte-2333783806].query-result .query,[svelte-2333783806] .query-result .query{font-family:monospace;margin:0;padding:2em}";
		appendNode(style, document.head);
	}

	function create_main_fragment(state, component) {
		var div, h3, text_1, div_1, text_2, pre, text_4, text_5, pre_1, text_8, h3_1, text_10, div_2, div_3, text_11, button, text_14, text_15, text_16;
		...
		return {
			c: function create() {
				...
				text_11 = createText("Add Selector:\n      ");
				button = createElement("button");
				button.textContent = "Add Empty Selector";
				text_14 = createText("\n    [\n    ");
				...
				if (changed.selectors) {
					for (var i = 0; i < selectors.length; i += 1) {
						if (each_1_blocks[i]) {
							...
							each_1_blocks[i] = create_each_block_4(state, selectors, selectors[i], i, component);
							each_1_blocks[i].c();
							each_1_blocks[i].m(div_2, text_15);
						}
					}
	...
	// (64:4) {{#each selectors as selector, index}}
	...
	function QueryEditor(options) {
		...
		if (!document.getElementById("svelte-2333783806-style")) add_css();
