/* src/LogalyzerApp.html generated by Svelte v1.41.1 */
...
function query(options, selectors) {
  ...
  toggleQueryEditor () {
	...
	function encapsulateStyles(node) {
		setAttribute(node, "svelte-1179564025", "");
	}

	function add_css() {
		var style = createElement("style");
		style.id = 'svelte-1179564025-style';
		style.textContent = "[svelte-1179564025].hidden,[svelte-1179564025] .hidden{display:none}[svelte-1179564025].loader,[svelte-1179564025] .loader,[svelte-1179564025].loader:after,[svelte-1179564025] .loader:after{border-radius:50%;width:3em;height:3em}[svelte-1179564025].loader,[svelte-1179564025] .loader{margin:60px auto;font-size:10px;position:relative;text-indent:-9999em;border-top:1.1em solid rgba(0,0,0, 0.2);border-right:1.1em solid rgba(0,0,0, 0.2);border-bottom:1.1em solid rgba(0,0,0, 0.2);border-left:1.1em solid #000000;-webkit-transform:translateZ(0);-ms-transform:translateZ(0);transform:translateZ(0);-webkit-animation:load8 1.1s infinite linear;animation:svelte-1179564025-load8 1.1s infinite linear}@-webkit-keyframes load8 {[svelte-1179564025]0%,[svelte-1179564025] 0%{-webkit-transform:rotate(0deg);transform:rotate(0deg)}[svelte-1179564025]100%,[svelte-1179564025] 100%{-webkit-transform:rotate(360deg);transform:rotate(360deg)}}@keyframes svelte-1179564025-load8{0%{-webkit-transform:rotate(0deg);transform:rotate(0deg)}100%{-webkit-transform:rotate(360deg);transform:rotate(360deg)}}";
	...
	function create_each_block(state, __aggregateFunctionsKeys, key, key_index, component) {
		var option, option_value_value, text_value = state.__aggregateFunctions[key].name, text;
	...
	function create_each_block_1(state, __chartFunctionsKeys, key_1, key_index_1, component) {
		var option, option_value_value, text_value = state.__chartFunctions[key_1].name, text;
	...
	function LogalyzerApp(options) {
		...
		if (!document.getElementById("svelte-1179564025-style")) add_css();
